...
public class registerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CreateAccountButton = (Button) findViewById(R.id.register_button_login);
        InputName = (EditText) findViewById(R.id.register_username);
        InputPassword = (EditText) findViewById(R.id.register_password_hint);
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!(dataSnapshot.child("Users").child(phone).exists()))
                {
                    ...
                    Toast.makeText(registerActivity.this, "This " + " already exists." , Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
